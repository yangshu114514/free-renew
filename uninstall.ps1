...
.DESCRIPTION
  ...
  - GitHub Variables：PLATFORM_PROVIDER、PLATFORM_FALLBACK、ZHIHU_TOPICS、NOTIFY_TAG、
    RUN_TIMEOUT_MINUTES，以及编号账号的备注名/停用开关（XXX_LABEL_N、XXX_ENABLED_N）
...
$VARS = @("PLATFORM_PROVIDER","PLATFORM_FALLBACK","ZHIHU_TOPICS","NOTIFY_TAG","RUN_TIMEOUT_MINUTES")
